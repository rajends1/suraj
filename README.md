...
Cloud formation script to create below AWS components
...
Ansible playbook to do following task
• Pick a Linux AMI
...
Create a script using any preferred programming language (python,
